...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return ((Yii::app()->getModule('user')->isAdmin())?array(
			...
			array('createtime, lastvisit, superuser, status, company_id', 'numerical', 'integerOnly'=>true),
	...
	public function scopes()
    {
        return array(
            ...
            'notsafe'=>array(
            	'select' => 'id, username, password, company_id, email, activkey, createtime, lastvisit, superuser, status',
            ),
        );
    }
    ...
    {
        return array(
            'select' => 'id, username, email, createtime, lastvisit, superuser, status, company_id',
        );
    }

    ...
    <div>      
      <div class="toolBotton">           
        <a id="Savebtn" class="imgbtn" href="javascript:void(0);">                
          <span class="Save"  title="Save the calendar">Lưu lại(<u>S</u>)
          </span>          
        </a>                           
        <?php if(isset($event)){ ?>
        <a id="Deletebtn" class="imgbtn" href="javascript:void(0);">                    
          <span class="Delete" title="Cancel the calendar">Xóa(<u>D</u>)
          </span>                
        </a>             
        <?php } ?>            
        <a id="Closebtn" class="imgbtn" href="javascript:void(0);">                
          <span class="Close" title="Close the window" >Đóng
          </span></a>            
        </a>        
      </div>                  
        ...
        <form action="<?php echo Yii::app()->controller->createUrl( '/wdcalendar/default/datafeed', array( 'method' => 'adddetails', 'id' => isset( $event ) ? $event->Id : '' ) ) ?>" class="fform" id="fmEdit" method="post"> 
          ...
          <label>                    
            ...
            <div>  
              ...
              <label class="checkp"> 
                <input id="IsAllDayEvent" name="IsAllDayEvent" type="checkbox" value="1" <?php if(isset($event)&&$event->IsAllDayEvent!=0) {echo "checked";} ?>/>          Sự kiện nguyên ngày                      
              </label>                    
            </div>                
          </label>                 
          <label>                    

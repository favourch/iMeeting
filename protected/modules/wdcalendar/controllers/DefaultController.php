...
class DefaultController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','edit', 'datafeed'),
				'users'=>array('@'),
			),
    ...
    public function settingsForJs()
    {
        ...
        $cs->registerScriptFile( $wdcalendar_assets . '/js/datepicker_lang_VI.js', CClientScript::POS_END);
    ...
    <script src="src/Plugins/jquery.colorselect.js" type="text/javascript"></script>    */
        ...
        $cs->registerScriptFile( $wdcalendar_assets . '/js/wdCalendar_lang_VI.js', CClientScript::POS_END);

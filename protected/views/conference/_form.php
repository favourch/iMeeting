...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<p class="note"> <?php echo Yii::t('conference','Thông tin đánh dấu'); ?> <span class="required">*</span> <?php echo Yii::t('conference','là bắt buộc');?>.</p>
	...
	<div class="row buttons">
		...
		<?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('conference','Tạo phòng họp') : Yii::t('conference','Lưu thay đổi')); ?>
	</div>
